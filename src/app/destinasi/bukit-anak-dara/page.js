...
export default function AnakDara() {
    return (
                            ...
                            <div class="container mx-auto">
                                <div class=" mx-auto flex flex-wrap">
                                    <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Bukit Anak Dara</h1>
                                        <div class="flex mb-4">
                                            <a class="flex-grow text-secondary border-b-2 border-secondary py-2 text-lg px-1">Description</a>
                                        </div>
                                        <p class="leading-relaxed mb-4">
                                        Bukit Anak Dara merupakan salah satu bukit tertinggi di Desa Sembalun, Lombok Timur dengan ketinggian 1.923 Mdpl. Termasuk dalam jajaran bukit tertinggi kedua setelah Bukit Nanggi Sembalun. Keindahan Bukit Anak Dara dapat dilihat secara langsung ketika berada di Desa Sembalun
                                        </p>
                                        <div class="flex border-t border-gray-200 py-2">
                                            <span class="text-gray-500">Ketinggian</span>
                                            <span class="ml-auto text-gray-900">1.923 Mdpl</span>
                                        </div>
                                        ...
                                        <a href="https://maps.app.goo.gl/Q8DUzxFCUmhtBiLG7" class="text-left items-center hover:text-secondary duration-200">
                                            <span class="">
                                            Lihat Lokasi
                                            </span>
